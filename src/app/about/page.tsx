...
export default function About() {
    ...
    return (
        <section
            id="about"
            className="relative w-full py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black text-black dark:text-white"
        >
            <motion.div
            ...
            >
                ...
                >
                    <div className="inline-flex items-center gap-3 border border-gray-300 dark:border-white/20 bg-white/80 dark:bg-white/10 px-4 py-2 rounded-lg shadow-sm">
                    ...
                    <motion.p
                        ...
                        className="text-base sm:text-lg leading-relaxed max-w-[700px] text-gray-700 dark:text-gray-300"
                    >
